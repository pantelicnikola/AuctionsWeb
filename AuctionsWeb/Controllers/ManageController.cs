...
namespace AuctionsWeb.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            {
                Account = await UserManager.FindByIdAsync(User.Identity.GetUserId())
            };
            return View(model);
        }
        ...
        public async Task<ActionResult> Index(IndexViewModel model)
        {
            ...
            //model.Account.Id = User.Identity.GetUserId();
            //await UserManager.UpdateAsync(model.Account);

            ViewBag.StatusMessage = "Your account info has been sucessfuly updated.";
            return View(model);
        }
